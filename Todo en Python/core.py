...
from ipr import (calcular_ipr_lineal, calcular_ipr_vogel, 
                 calcular_ipr_backpressure, calcular_ipr_darcy_gas)
...
def encontrar_interseccion(curva_IPR, curva_VLP):
    ...
    if idx_change.size == 0:
        ...
        if abs(F2 - F1) < 1e-9:
            ...
            pwf_op = np.interp(qop, Q_ipr, P_ipr)
            return (qop, pwf_op)
...
def correr_simulacion_completa(datos):
    ...
    # =====================================================================
    # [INICIO DE CORRECCIÓN] - Lógica para leer banderas 1/0 (Ansari AÑADIDO)
    # =====================================================================
